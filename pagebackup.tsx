...
import { Sparkles, Star, Calendar, Shield, DollarSign, Users, Layout, Bot } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto px-2">
        {[
          ...
          <div key={idx} className="text-center">
            ...
            <h3 className="text-[22px] font-semibold mb-5" style={{ color: "#222222" }}>{step.title}</h3>
...
export default function VendorLandingPage() {
  const handleJoinPartaiBook = () => {
    // Add your signup/onboarding logic here
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 px-8 pb-8">
        <div className="container mx-auto text-center">
          ...
          <Button onClick={handleJoinPartaiBook} className="mb-12 px-6 py-3 text-base rounded-xl" style={{ backgroundColor: "#FF8C42", color: "white", border: "none" }}>
            Become a Founding Vendor
          </Button>
          
          <div className="flex flex-wrap justify-center gap-3">
            <Badge className="border px-4 py-2 rounded-xl" style={{ borderColor: "#A78BFA", color: "#A78BFA" }}>
              Instant Bookings
            </Badge>
            <Badge className="border-primary text-primary px-4 py-2 rounded-xl border">
              Free to Join
            </Badge>
            <Badge className="border-accent text-accent px-4 py-2 rounded-xl border">
        ...
        <div className="container mx-auto max-w-6xl text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              {
                title: "Photographers & Photo Booths",
          ...
          <div className="mt-8">
            <p className="text-lg font-medium" style={{ color: "#222222" }}>
              Anyone who brings parties to life!
            </p>
          </div>
        </div>
      </section>
